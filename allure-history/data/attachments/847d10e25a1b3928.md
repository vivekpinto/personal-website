...
- Location: e2e/tests/functional/experience.spec.ts:13:3
...
Locator: getByRole('heading', { name: 'Senior Quality Engineer & Accessibility Specialist', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Senior Quality Engineer & Accessibility Specialist', exact: true })
...
- main:
  ...
  - status:
    ...
    - strong: Passed
    - paragraph: 4 of 4 tests passed
    - text: Passed 4 Failed 0 Skipped 0 Timed Out 0 Pass Rate 100% Last Run 9/10/2026, 4:34:18 AM
    - button "▶ Run Automation Tests"
    - link "📊 View Allure Report":
      - /url: https://vivekpinto.github.io/personal-website/test-report/?v=2026-09-10T04%3A34%3A18.853Z
...
> 15 |     await expect(page.getByRole('heading', {name: 'Senior Quality Engineer & Accessibility Specialist', exact: true})).toBeVisible();
     |                                                                                                                        ^ Error: expect(locator).toBeVisible() failed
