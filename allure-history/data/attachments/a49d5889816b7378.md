...
Locator: getByRole('heading', { name: 'Senior Quality Engineer and Accessibility Specialist', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Senior Quality Engineer and Accessibility Specialist', exact: true })
...
- main:
  ...
  - article:
    - heading "Quality Assurance Engineer | Accessibility Specialist" [level=3]
  ...
  - status:
    ...
    - strong: Passed
    - paragraph: 3 of 3 tests passed
    - text: Passed 3 Failed 0 Skipped 0 Timed Out 0 Pass Rate 100% Last Run 9/10/2026, 3:08:12 AM
    - button "▶ Run Automation Tests"
    - link "📊 View Allure Report":
      - /url: https://vivekpinto.github.io/personal-website/test-report/?v=2026-09-10T03%3A08%3A12.026Z
