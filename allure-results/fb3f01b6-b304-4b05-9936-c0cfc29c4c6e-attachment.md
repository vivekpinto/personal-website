...
Call log:
  - waiting for getByRole('link', { name: 'Zeus Learning', exact: true })
    - locator resolved to <a target="_blank" rel="noopener noreferrer" href="https://zeuslearning.com/" class="experience-card__company" aria-describedby="opens-new-tab-description">…</a>
      ...
      - status [ref=e200]:
        - generic [ref=e201]:
          ...
          - generic [ref=e203]:
            - generic [ref=e204]: ✓
            - generic [ref=e205]:
              - strong [ref=e206]: Passed
              - paragraph [ref=e207]: 6 of 6 tests passed
          - generic [ref=e208]:
            - generic [ref=e209]:
            ...
            - generic [ref=e224]:
              ...
              - generic [ref=e226]: 9/10/2026, 1:37:32 PM
          - generic [ref=e227]:
            - button "▶ Run Automation Tests" [ref=e228]
            - link "📊 View Allure Report" [ref=e229] [cursor=pointer]:
              - /url: https://vivekpinto.github.io/personal-website/test-report/?v=2026-09-10T08%3A07%3A32.780Z
    - generic [ref=e231]:
...
> 17 |         await this.companyZeusLink.click();
     |                                    ^ Error: locator.click: Test timeout of 30000ms exceeded.
  18 |         await this.page.waitForLoadState();
  19 |         await expect(this.page).toHaveURL('https://zeuslearning.com/');
  20 |         await this.page.close();
  21 |     }
  22 | 
  23 | 
  24 | }
